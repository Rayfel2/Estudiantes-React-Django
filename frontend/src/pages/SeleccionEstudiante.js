import styles from "./SeleccionEstudiante.module.css";
...
const SeleccionEstudiante = () => {
  ...
  return (
    <div className={styles.seleccionEstudiante}>
      ...
      <b className={styles.revisionDeMaterias}>Revision de materias</b>
      <div className={styles.vectorParent}>
        ...
        <div className={styles.parent}>
          ...
          <div className={styles.div9}>
            ...
            <input className={styles.boxunchecked3} type="checkbox" />
          </div>
        ...
        <div className={styles.revision}>Revision</div>
      </div>
      ...
      <div className={styles.menuPrincipal}>
        ...
        <div className={styles.vectorGroup}>
          ...
          <b className={styles.revisionDeMateria1}>Revision de materia</b>
          <img
...
export default SeleccionEstudiante;
